...
media-ctl -v -V '"60005000.rgb-scaler":0 [fmt:RBG888_1X24/1920x1080 crop: (0,0)/1920x1080 field:none colorspace:srgb]' -d $capture_media
media-ctl -v -V '"60007000.generic-video-pipeline":0 [fmt:RBG888_1X24/1920x1080 field:none colorspace:srgb]' -d $capture_media
v4l2-ctl --device $capture_video --set-fmt-video=width=1920,height=1080,pixelformat=YUYV
