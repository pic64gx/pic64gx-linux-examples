...
gst-launch-1.0 v4l2src device=$capture_video num-buffers=10 ! videoconvert ! video/x-raw,width=1280,height=720 ! jpegenc ! multifilesink index=0 location=frame%04d.jpg sync=true async=false
