...
gst-launch-1.0 -vvv multifilesrc location=/opt/microchip/multimedia/hdmi/Microchip_log.jpg  loop=true ! jpegdec ! videoconvert  ! video/x-raw, format=YUY2, width=1280, height=720, interlace-mode=progressive ! v4l2sink device=/dev/video0
